    ...
    <div class="">
        <div class="page-title">
            ...
            <div class="title_right">
                <div class="col-md-5 col-sm-5   form-group pull-left top_search">
                                        ...
                                        <div class="row fontawesome-icon-list">
                                            ...
                                            <div class="col-md-3 col-sm-12 form-group">
                                                ...
                                                <div class=" fa-hover col-md-3 col-sm-12">
                                                    <a href="<?php echo base_url('index.php/Dashboard_pelamar/simpan_lamaran');?>?id_loker=<?=$a['id_loker']?>" style="height: 50px; padding: 5px">
                                                        <i class="fa fa-star-o" style="font-size: 40px;"></i></a>
                                                </div>
                                            </div>
